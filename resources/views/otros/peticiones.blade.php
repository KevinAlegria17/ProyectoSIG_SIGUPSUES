    ...
    <div class="col-md-12">
      ...
      <form  method="POST" target="_blank">
              ...
              <div class="col-xs-11">
                ...
                <div class="panel panel-success">
                  ...
                  <div class="panel-body">
                    ...
                    <table width="300" style="clear: both;">
                      <tr>
                        <td width="150"> <br><br> <button formaction="{{ route('cantidadPeticiones') }}" type="submit" class="btn btn-block btn-primary btn-xs"  style='width:100px; height:40px' target="_blank">Ver Reporte</button> </td>
                        <td width="150"><br><br>
                ...
                <p align="center"><a class="btn btn-danger" href="/otros" role="button"><i class="fa fa-backward"> Cancelar y regresar</i></a></p>
              </div><!-- /.box-body -->
            </form>
