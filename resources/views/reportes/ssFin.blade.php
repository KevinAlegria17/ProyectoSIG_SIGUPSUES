  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        ...
        <p>Este reporte contiene la cantidad de alumnos que terminaron su servicio social en el año {{$anio}} y tambien los datos de estos alumnos. <br>Generado el 28/06/2018</p>
      </div><!-- /.box-header -->
      <div class="box-body">
