 ...
 <body>
  ...
  <div class="row cuerpo">
    ...
    <div style="width: 100%; clear: both;">
      <h4 align="center">REPORTE DE SERVICIO SOCIAL MAS DEMANDADO</h4>
      <p>Este reporte contiene informacion acerca del servicio social mas demandado y cuantos veces esta presente en cada escuela.</p>
      Desde {{$fecha1}} HASTA {{$fecha2}}<br/><br/>
      Tipo de Servicio Social: Proyecto
        <table  class="table-1 table table-bordered ">
          <thead>
            <tr >
              <th style="text-align: left;">Escuela</th>
              <th style="text-align: left;">Cantidad de peticiones</th>
            </tr>
          </thead> 
          <tbody>
