  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h2> Reporte de proyectos con cupos disponibles</h2>
        <p>Este reporte contiene los proyectos que tienen cupos disponibles para el ingreso de algun estudiante que quiera realizar servicio social.<br>Generado el 28/06/2018</p>
      </div><!-- /.box-header -->
      <div class="box-body">
        <table  class="table-1 table table-bordered ">
          <thead>
            <tr >
              ...
              <th style="text-align: left;">Cupos totales</th>
              <th style="text-align: left;">Estudiantes actuales</th>
              <th style="text-align: left;">Cupos Disponibles</th>
            </tr>
          </thead> 
          <tbody>
           @foreach($sss as $ss)
           <tr >
            <td>{{$ss->nombre}}</td>
            <td align="center">{{$ss->cupos_totales}}</td>
            <td align="center">{{$ss->actuales}}</td>
            <td align="center">{{$ss->disponibles}}</td>
          </tr>
          @endforeach
        </tbody>
        <tfoot>
