      ...
      <form  method="POST" target="_blank">
              ...
              <div class="col-xs-11">
                <div class="alert alert-warning alert-dismissable" class="col-xs-5">
                  ...
                  <h4>El reporte contendrá los proyectos que tienen de cupos disponibles</h4>
                <div class="panel panel-success">
                  ...
                  <div class="panel-body">
                    ...
                    <table width="300" style="clear: both;">
                      <tr>
                        <td width="150"> <br><br> <button formaction="{{ route('reporteCupos') }}" type="submit" class="btn btn-block btn-primary btn-xs"  style='width:100px; height:40px' target="_blank">Ver Reporte</button> </td>
                        <td width="150"> <br><br>
                          <button formaction="{{ route('reporteCuposDescargar') }}" type="submit" class="btn btn-block btn-success btn-xs" id="download" name="download" target="_blank" style='width:100px; height:40px'>Descargar</button> 
                        </td>
                      </tr>
                    </table>
                    <br><br>
